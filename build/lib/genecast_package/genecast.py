...
def main():
    ...
    if subCommand == 'cnv':
        ...
        snv(hg=args.host_gene, group=[args.group1, args.group2], p=args.pval, method=args.feature_selection_method,
            pm=args.prediction_method, tg=args.outdir, C=args.C, n_folds=args.n_folds,
            criterion=args.criterion, penalty=args.penalty, threshold=args.threshold, dt=aargs.data_type, cal=args.cal_type)
...
def add_make_ln(subparser):
    ...
    parser.add_argument('-r', '--research', choices=("yes", "no"), required=False, default=True,
